  ...
  return (
    <>
      <div className="prose mt-8 p-6 grid grid-cols-1 gap-y-8 max-w-full sm:grid-cols-6">
        ...
        {/* <h3 className="mb-4 text-left">Quick Access</h3>
          <div className="space-x-20 flex shadow-lg rounded-lg justify-around p-10 mb-10 mt-2.5">
            <div>
        ...
        {!initialGid && !initialCourse && remainingCount < 0 ? (
          <h3>No courses available to view</h3>
        ) : (
